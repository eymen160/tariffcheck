...
Brokers file entries; they almost never *audit* them retrospectively — protest work is manual and hourly-unprofitable at SMB entry values, so it goes to trade lawyers at $500+/hr or simply doesn't happen. That's why CBP found $310M in lost revenue in a single month. We don't compete with brokers — **brokers are our first customers**: a bulk-scan tool that turns declined protest work into a new fee line. And the broker who filed the entry has a mild conflict of interest in finding their own errors — an independent audit layer is a position no brokerage can take, since their revenue depends on the entries they filed. Caspian and Pax raised ~$10M combined for the *adjacent* refund mechanism (duty drawback) — proof this buyer pays for recovered money — and neither touches classification or §1514 protests.
